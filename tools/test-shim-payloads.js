...
for (const name of ['SCROLL_FIX', 'WCO_FIX', 'SCROLL_INTENT_FIX']) {
  try {
...
for (const name of ['SCROLL_FIX', 'WCO_FIX', 'REPAINTER_FIX', 'SCROLL_INTENT_FIX']) {
...
// FreeBuff ad removal removed for ToS compliance.
check(src.indexOf('executeJavaScript(AD_BLOCK') < 0,
  'AD_BLOCK stays out of the injector (FreeBuff ToS compliance)');
