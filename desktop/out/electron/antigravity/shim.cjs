...
const REPAINTER_FIX = `(() => {
  ...
  let B_OUTER = \`border: 2px solid !important; border-color: #4B6678 #0D0F17 #0D0F17 #4B6678 !important; box-shadow: none !important;\`;
  let B_INNER = \`border: 2px solid !important; border-color: #0D0F17 #4B6678 #4B6678 #0D0F17 !important; box-shadow: none !important;\`;
  let B_SUNK = \`border: 2px solid !important; border-color: #0D0F17 #4B6678 #4B6678 #0D0F17 !important; box-shadow: none !important;\`;
