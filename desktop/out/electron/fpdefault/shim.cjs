...
const REPAINTER_FIX = `(() => {
  ...
  let B_OUTER = \`border: 2px solid !important; border-color: #4E555B #0A0A0A #0A0A0A #4E555B !important; box-shadow: none !important;\`;
  let B_INNER = \`border: 2px solid !important; border-color: #0A0A0A #4E555B #4E555B #0A0A0A !important; box-shadow: none !important;\`;
  let B_SUNK = \`border: 2px solid !important; border-color: #0A0A0A #4E555B #4E555B #0A0A0A !important; box-shadow: none !important;\`;
