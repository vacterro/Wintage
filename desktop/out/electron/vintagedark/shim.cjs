...
const REPAINTER_FIX = `(() => {
  ...
  let B_OUTER = \`border: 2px solid !important; border-color: #4A5258 #0A0A0A #0A0A0A #4A5258 !important; box-shadow: none !important;\`;
  let B_INNER = \`border: 2px solid !important; border-color: #0A0A0A #4A5258 #4A5258 #0A0A0A !important; box-shadow: none !important;\`;
  let B_SUNK = \`border: 2px solid !important; border-color: #0A0A0A #4A5258 #4A5258 #0A0A0A !important; box-shadow: none !important;\`;
